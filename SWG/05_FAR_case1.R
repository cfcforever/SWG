nPC = 2
#### case_1: only PCS from 1979 to 1997 ####
MON=c(12,1:11)
...
for (seas in 1:4){
  ...
  # output = paste('~/Documents/LSCE/SWG/t2m/case_1/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1979_1997.RData',sep="")
  output = paste('~/Documents/LSCE/SWG/t2m/case_1/', nPC, 'PC/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1979_1997.RData',sep="")
  cat(output,'\n')
...
for (seas in 1:4){
  ...
  PCS = PCS[,1:nPC]   # just nPC
  NB_pred=dim(PCS)[2]
  
  
  # Nom du fichier sauvegardé contenant les estimations
  # filename=paste('~/Documents/LSCE/SWG/t2m/case_1/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1979_1997.RData',sep="")
  filename=paste('~/Documents/LSCE/SWG/t2m/case_1/', nPC, 'PC/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1979_1997.RData',sep="")
  load(filename)
...
save(sd, mean, file = paste0("~/Documents/LSCE/SWG/t2m/case_1/", nPC, "PC/tmean_mean_sd_1998_2017_nat.RData"))

#### case_1: estimation of model-2 from 1998 to 2017 for factual ####
MON=c(12,1:11)
MON=matrix(MON,nrow=4,ncol=3,byrow=T)
SEAS=c('DJF','MAM','JJA','SON')
season=c('Winter','Spring','Summer','Fall')
...
for (seas in 1:4){
  ...
  # output = paste('~/Documents/LSCE/SWG/t2m/case_1/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1998_2017.RData',sep="")
  output = paste('~/Documents/LSCE/SWG/t2m/case_1/', nPC, 'PC/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1998_2017.RData',sep="")
  cat(output,'\n')
  save(fit_stations_tt,file = output)
...
#### case_1: estimation of mean and sd from 1998 to 2017 for factual ####
# period for projection (1998 - 2017)
DATE_proj = atoms(timeSequence(from="1998-01-01",to="2017-12-31",by='day'))
LENGTH_proj = dim(atoms(timeSequence(from="1998-01-01",to="2017-12-31",by='day')))[1]
...
for (seas in 1:4){
  ...
  # filename=paste('~/Documents/LSCE/SWG/t2m/case_1/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1998_2017.RData',sep="")
  filename=paste('~/Documents/LSCE/SWG/t2m/case_1/', nPC, 'PC/SWG_ERAI_ESD_tmean_',season[seas],'_cross-val_1998_2017.RData',sep="")
  load(filename)
...
# save(mean, sd, file = "~/Documents/LSCE/SWG/t2m/case_1/tmean_mean_sd_1998_2017_rea.RData")
save(mean, sd, file = paste0("~/Documents/LSCE/SWG/t2m/case_1/", nPC, "PC/tmean_mean_sd_1998_2017_rea.RData"))
