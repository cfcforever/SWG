...
for (seas in 1:4){
  ...
  for (ncase in 1:3){
    ...
    load(paste0("~/Documents/LSCE/SWG/tp/case_", ncase, "/SIMU/SIMU_precip_", SEAS[seas], "_run_001.RData"))
    Sample = Sample_seas
    ...
    dev.print(pdf, file = paste0("~/Documents/LSCE/SWG/tp/Images/acf_", SEAS[seas],"_case_", ncase, ".pdf"), width = 7, height = 7)
