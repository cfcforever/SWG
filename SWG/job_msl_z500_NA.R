...
# normalize dat -> dat_scale
dat_scale = apply(dat, MARGIN = 2, scale)
table_scale = cbind(colMeans(dat_scale), apply(dat_scale, 2, FUN = sd))
# save(dat_scale, file = "/Volumes/Data-ExFAT/dat_scale.RData")

distance = dist(dat_scale, upper = T, diag = T)
# save(distance, file = "/Volumes/Data-ExFAT/dist_scale.RData")
d = as.matrix(distance)
# save(d, file = "/Volumes/Data-ExFAT/distance_2.RData")
...
# save(dim, file = "~/Documents/LSCE/Dynamic System/msl_z500_19790101-20180731_NA_1.5x1.5_dim_scale.RData")
# save(theta, file = "~/Documents/LSCE/Dynamic System/msl_z500_19790101-20180731_NA_1.5x1.5_theta_scale.RData")
