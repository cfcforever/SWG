...
DATE_ERAI= atoms(timeSequence(from="1979-01-01",to="1998-12-31",by='day'))
DATE_ERAI2= atoms(timeSequence(from="1999-01-01",to="2008-12-31",by='day'))

#datadir="/home/estimr1/pvait/RDATA/"
ngrid = 1

P1 = array(NaN,c(dim(DATE_ERAI)[1],ngrid)) # matrice de probas d'occurrence
shape = array(NaN,c(dim(DATE_ERAI)[1],ngrid))
rate = array(NaN,c(dim(DATE_ERAI)[1],ngrid))

P12 = array(NaN,c(2,dim(DATE_ERAI2)[1],ngrid)) # matrice de probas d'occurrence
shape2 = array(NaN,c(2,dim(DATE_ERAI2)[1],ngrid))
rate2 = array(NaN,c(2,dim(DATE_ERAI2)[1],ngrid))
...
for(ifold in 1:2){
  ...
  for(seas in 1:4){
    ...
    if(experiment == "kfold"){
      ...
      idx_proj2_dates=which((DATE_ERAI['Y']>=1999) & (DATE_ERAI['Y']<=2008)) # 2004 - 2012
      ...
      P12[ifold, (idxdates[idx_proj2_dates] - 7305),] = tempP12
      shape2[ifold, (idxdates[idx_proj2_dates] - 7305),] = tempshape2
      rate2[ifold, (idxdates[idx_proj2_dates] - 7305),] = temprate2
...
save(P12,shape2,rate2,DATE_ERAI2, file = paste('~/Documents/LSCE/SWG/tp/FieldParameters_SWG_ERAI_PR_',experiment,'_1999_2008.RData',sep=""))
...
library(timeDate)
DATE = atoms(timeSequence(from="1999-01-01",to="2008-12-31",by='day'))
...
for(i in 1:1){
  ...
  for(ifold in 1:2){
    ...
    cat(" ifold")
    Sample_temp = Sample_binomocc_gammaity(as.data.frame(P12[ifold,,idx]),as.data.frame(shape2[ifold,,idx]),as.data.frame(rate2[ifold,,idx]))
    ...
    filesimu = paste('~/Documents/LSCE/SWG/tp/SIMU_SWG_PR_ERAI_PR_',experiment,'_1999_2008_ifold_',ifold,'_run_',NUM,'.RData',sep="")
...
load("/Users/shengchen/Documents/LSCE/SWG/tp/SIMU_SWG_PR_ERAI_PR_kfold_1999_2008_ifold_1_run_001.RData")
Sample_1 = Sample[1,,1]
range(Sample_1)

load("/Users/shengchen/Documents/LSCE/SWG/tp/SIMU_SWG_PR_ERAI_PR_kfold_1999_2008_ifold_2_run_001.RData")
Sample_2 = Sample[2,,1]
range(Sample_2)
